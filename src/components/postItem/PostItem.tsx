    ...
    return (
        <div
            ...
            className={`relative flex flex-col justify-between w-full gap-4 p-4 shadow-xl rounded-xl cursor-pointer
                bg-bottom bg-no-repeat bg-contain dark:bg-blend-darken border dark:border-custom-color-dark-4 ${className}`}
            onClick={onClick}
        >
            ...
            <div className="flex flex-col">
                <div
                    className="flex flex-col justify-center gap-1 p-2 w-full rounded-xl shadow-inner 
                        text-black/80 dark:text-white border dark:border-custom-color-dark-7 bg-custom-color-5/80 dark:bg-custom-color-dark-5/80"
                >
